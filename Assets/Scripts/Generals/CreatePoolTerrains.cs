...
public class CreatePoolTerrains : MonoBehaviour
{
    ...
    public List<GameObject> listTypeTerrain = new List<GameObject>(); // Prefabs of Terrains
    public List<ListCodeTerrain> listSceneTerrain = new List<ListCodeTerrain>(); // Terrains Code
    public List<ListUseTerrain> listUseTerrain = new List<ListUseTerrain>(); // Instantiated terrains
